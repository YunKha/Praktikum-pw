<x-default-layout title="Student" section_title="Add now student">
        ...
        <form action="" method="POST"
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div class="flex flex-col gap-2">
                    ...
                    <input type="phone_number" id="phone_number" name="phone_number" class="px-3 py-2 border border-zinc-300 bg-slate-50"
            ...
            <div class="flex flex-col gap-2">
                ...
                <select name="majors" id="majors" class="px-3 py-2 border border-zinc-300 appearance-none bg-slate-50">
                    ...
                    <option value="1">S1 Sistem Informasi</option>
